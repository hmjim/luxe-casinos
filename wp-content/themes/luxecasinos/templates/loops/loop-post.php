...
<article class="slot">
	<div class="slot__inner">
		...
		<a href="<?php the_permalink(); ?>" class="slot__thumb">
			<img src="<?= kama_thumb_src( 'w=280 &h=152', get_post_thumbnail_id() ); ?>" title="<?php echo $thumb->post_title; ?>" alt="<?php echo $image_alt; ?>">
		</a>

		<div class="slot__btns">
			<a href="<?php the_permalink(); ?>" class="btn btn-demo">Демо</a>
			<a href="<?= $link; ?>" class="btn btn-play">На деньги</a>
		</div>
	</div>
</article>
